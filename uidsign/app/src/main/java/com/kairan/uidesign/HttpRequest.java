...
abstract class HttpRequest extends AsyncTask<String,String,String> {
    ...
    public static void setAuthority(String authority) {
        HttpRequest.authority = authority;
    }
...
//            Uri.Builder builder = new Uri.Builder();
            URL myUrl = new URL(makeURL(getAuthority()).toString());
            //Create a connection
    ...
    public Uri makeURL(String activity){
        Uri.Builder builder = new Uri.Builder();
        builder.scheme("https")
                .authority("somapass.xyz")
                .appendPath(activity)
                .appendPath(useridtosend)
                .appendPath(passwordtosend);
